...
int main(int argc, char **argv) {
	...
	Centroids centroids;
	size_t iterations = kMeans(data, 10, centroids, 1000);  //// data, numclusters, centroids
	...
	for(std::size_t i=0; i != elements; i++) {
		if(clusters.element(i)) 
			c1 << data.element(i)(0) << " " << data.element(i)(1) <<  " " << data.element(i)(2) << endl;
		else 
			c2 << data.element(i)(0) << " " << data.element(i)(1) <<  " " << data.element(i)(2) << endl;
	}
